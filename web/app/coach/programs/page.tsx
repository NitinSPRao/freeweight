...
import { programApi, folderApi, FolderContents } from "@/lib/api-endpoints";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {subfolders.map((folder) => (
                <div
                  ...
                  className="relative flex flex-col gap-3 p-5 rounded-xl border border-secondary/20 bg-secondary/5 hover:border-primary/30 hover:bg-secondary/10 transition-colors cursor-pointer"
                >
                  {/* Three-dot menu */}
                  <div
                        ...
                        <button
                          onClick={() => {
                            ...
                            setMoveModal({
                              ...
                              itemType: "folder",
                              id: folder.id,
                              currentLocationId: folder.parent_id,
                            });
                          }}
                          className="w-full text-left px-4 py-2.5 text-sm text-zinc-100 hover:bg-zinc-800 transition-colors"
                        >
                        ...
                        <button
                          onClick={() => {
                            ...
                            setMoveModal({
                              ...
                              itemType: "program",
                              id: program.id,
                              currentLocationId: program.folder_id ?? null,
                            });
                          }}
                          className="w-full text-left px-4 py-2.5 text-sm text-zinc-100 hover:bg-zinc-800 transition-colors"
                        >
            ...
            <div className="bg-background border border-secondary/30 rounded-2xl shadow-2xl w-full max-w-[520px] p-8 relative">
              ...
              <button
                onClick={() => {
                  ...
                  if (modalProgramType === "rehab") params.set("type", "rehab");
